<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="removec.aspx.cs" Inherits="removec" %>
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Remove Client</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
