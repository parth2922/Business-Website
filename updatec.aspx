<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="updatec.aspx.cs" Inherits="updatec" %>
             ...
             <div class="card-body">
               <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <asp:Button ID="Button1" runat="server" Text="Update Client" class="btn btn-primary" OnClick="Button1_Click"  />
                  </div>
                  <div class="form-group">
